...
@section('content')
    <div class="container container-tight py-4">
        ...
        <div class="card card-md">
            <div class="card-body">
                <h2 class="h2 text-center mb-4">CNS-Materno Infantil</h2>
                <form action="{{route('login')}}" method="post" autocomplete="off" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control @error('email') is-invalid @enderror" name="email"
                               ...
                               autocomplete="off">
                        @error('email')
                        <div class="invalid-feedback">{{"Inserción incorrecta"}}</div>
                        @enderror
                    </div>
                    <div class="mb-2">
                    ...
                    {{-- <a href="#" class="link-secondary" title="Mostrar contraseña" data-bs-toggle="tooltip"><!-- Download SVG icon from http://tabler-icons.io/i/eye -->
        ...
        @if(Route::has('register'))
            <div class="text-center text-muted mt-3">
                Sin cuenta? <a href="{{route('register')}}" tabindex="-1">Registrate</a>
            </div>
        @endif
    </div>
@endsection
